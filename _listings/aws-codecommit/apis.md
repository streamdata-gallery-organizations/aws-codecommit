...
- name: AWS CodeCommit API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-codecommit/master/_listings/aws-codecommit/action-updaterepositoryname-get.md
x-common:
